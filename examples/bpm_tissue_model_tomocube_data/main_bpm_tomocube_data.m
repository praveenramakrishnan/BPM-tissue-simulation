...
if simulate_background
    saveas(figure_bpm_1d_along_x, append(output_directory, ...
        'figure_bpm_brain_tissue_along_x_background.png'));
    else
    saveas(figure_bpm_1d_along_x, append(output_directory, ...
        'figure_bpm_brain_tissue_along_x.png'));
end
...
if simulate_background
    saveas(figure_bpm_1d_along_y, append(output_directory, ...
        'figure_bpm_brain_tissue_along_y_background.png'));
else
    saveas(figure_bpm_1d_along_y, append(output_directory, ...
...
function refractive_index_data = get_refractive_index_data( ...
    ...
    if simulate_background
        ...
        refractive_index_data = refractive_background*ones(...
